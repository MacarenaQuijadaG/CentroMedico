...
//COPIA DEL ARREGLO
var copiaTraumatologia = traumatologia.slice();
// PUNTO 1 AGREGAR AL ARREGLO

var nuevasHorasTraumatologia = [
...
// Agregar las nuevas horas de Traumatología a la copia utilizando push()
copiaTraumatologia.push(...nuevasHorasTraumatologia);

// Mostrar el resultado en la consola
console.log(copiaTraumatologia);

// PUNTO 2 ELIMINAR PRIMERO Y ULTIMO

//COPIA DEL ARREGLO DE RADIOLOGIA
var copiaRadiologia = radiologia.slice();
// Eliminar el primer elemento del arreglo de Radiología
var primerElementoRadiologia = copiaRadiologia.shift();

// Eliminar el último elemento del arreglo de Radiología
var ultimoElementoRadiologia = copiaRadiologia.pop();
...
var pacientesTotales = radiologia.concat(traumatologia, dental);
document.write("<h2>Pacientes Totales</h2>");
// Imprimir cada nombre de paciente en un nuevo párrafo
...
var pacientesISAPRE = dental.filter(function(paciente) {
    return paciente.prevision === 'ISAPRE';
});
document.write("<h2>Pacientes de Isapre consulta medica dental </h2>");
// Imprimir los pacientes de ISAPRE 
...
var pacientesFONASA = traumatologia.filter(function(paciente) {
    return paciente.prevision === 'FONASA';
});

document.write("<h2>Pacientes de Fonasa consulta Traumatologia </h2>");
// Imprimir los pacientes de FONASA 
pacientesFONASA.forEach(function(paciente) {
    document.write(`<p>${paciente.paciente}</p>`);
});

document.write(`<p>--------------------------------------------------------------------------------------------</p>`);
// lo que traia el ejercicio
